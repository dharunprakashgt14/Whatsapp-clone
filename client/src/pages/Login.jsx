...
const Login = () => {
  ...
  const handleSendOtp = async (e) => {
    ...
    setLoading(true);
    try {
      const { data } = await sendOtp({ email, mode: 'login', channel: 'email' });
      setOtpSent(true);
      setDemoOtp(data.otp || '');
    } catch (err) {
  ...
  const handleVerifyOtp = async (e) => {
    ...
    setLoading(true);
    try {
      const { data } = await verifyOtp({ email, otp, mode: 'login', channel: 'email' });
  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        ...
        <p className="auth-subtitle">Sign in with your email OTP</p>
